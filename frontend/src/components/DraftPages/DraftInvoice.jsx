...
const Invoice = () => {
    ...
    const columns = [
        ...
        "Transaction Type", "Total Amount", "Due", "Purchase Order img/pdf", "Print", "View"
    ];
    ...
    const fetchSalesHistory = async () => {
        try {
            ...
            const filteredInvoices = invoices.filter(invoice => invoice.status === "invoice" && invoice.draft === "true");
