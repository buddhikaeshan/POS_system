...
const DraftDelivery = () => {
  ...
  const columns = ["ID", "Delivery Note No","Date/time", "Type", "Customer", "Customer Office", "Purchase Order No",
    "Store","Transaction Type", "Credit pay", "Due", "Purchase Order img/pdf","Draft"];
  ...
  const title = 'Draft_Delivery';
  const invoice = 'Draft_Delivery.pdf';
