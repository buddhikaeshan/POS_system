...
const InvoiceNote = () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setFormData({
                    ...
                    // newInvoiceNo:"INV-"+ invoiceData.invoiceNo+"-"+invoiceYear,
    ...
    useEffect(() => {
        generateInvoiceNo();
    }, [formData.invoiceDate ,invoiceNo]);

    const generateInvoiceNo = () => {
        if (!formData.invoiceDate || invoiceNo) return;

        const invoiceDate = new Date(formData.invoiceDate);
        const invoiceYear = invoiceDate.getFullYear().toString().slice(-2);
        const invoiceDateOnly = invoiceDate.toISOString().split("T")[0];

        const newinvoiceNo = `INV-${invoiceNo}-${invoiceYear}`;
                            ...
                            <section className="billing-details">
                                ...
                                <div className="invoice-info">
                                    ...
                                    <div className="details mb-2">
                                        ...
                                        <input type="date" className="form-input date" name="invoiceDate" value={formData.invoiceDate} />
                                    </div>
                                    <div className="details ">
                                ...
                                <tbody>
                                    <tr>
                                        <td id="table-content" colSpan={5} rowSpan={5}>
                                            {/* {showBank && (
                                                <>
                                                    Payment mode : Cash or cheque. All cheques are to be drawn in favour of "Colkan Holdings (Pvt) Ltd" and crossed account payee only payee only<br></br>
                                                    {Colkan && (
                                                        <>
                                                            Bank:HNB<br></br>
                                            ...
                                            {showBank && (
                                                <>
                                                    ...
                                                    {Haman && (
                                                        <>
                                                            Payment mode : Cash or cheque. All cheques are to be drawn in favour of "Haman" and crossed account payee only payee only<br></br>
                                                            Bank:BOC<br></br>
                                                            Account Number : 93829087<br></br>
                                                            Account Name : Haman<br></br>
                                                            Branch Name : Wellewathe
                                                    ...
                                                    {TerraWalkers && (
                                                        <>
                                                            Payment mode : Cash or cheque. All cheques are to be drawn in favour of "Terra Walkers" and crossed account payee only payee only<br></br>
                                                            Bank:Sampath Bank<br></br>
                                                            Account Number : 0117 1000 1407<br></br>
                                                            Account Name : TerraWalkers walkers<br></br>
                                                            Branch Name : Kirulapona
